...
const createUserValidation = Yup.object().shape({
    ...
    mobile: Yup.string().required("وارد کردن این فیلد الزامی است").max(11, "شماره تماس وارد شده بیش از حد مجاز است").matches("^09[0-9]{9}$", "شماره تماس وارد شده معتبر نیست"),
