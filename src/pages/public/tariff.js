                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="mb-1 card-title primary-font">طرح طلایی</h5>
                                <span class="lh-1-85">تمام امکانات جلسه</span>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="mb-1 card-title primary-font">طرح نقره ای</h5>
                                <span class="lh-1-85">تمام امکانات جلسه</span>
                                <div class="d-flex align-items-center justify-content-center my-3 gap-2">
                                    <a href="javascript:;" class="me-1"><span class="badge bg-label-secondary">کنفرانس</span></a>
                                    <a href="javascript:;"><span class="badge bg-label-success">حضوری</span></a>
                                </div>

                                <div class="d-flex align-items-center justify-content-around my-4 py-2">
                                    <div>
                                        <h4 class="mb-1">750,000</h4>
                                        <span>پیامک</span>
                                    </div>
                                    <div>
                                        <h4 class="mb-1">100</h4>
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    <a href="#" class="btn btn-success d-flex align-items-center me-3"><i class="bx bx-user-check me-1"></i>خرید</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="mb-1 card-title primary-font">طرح برنزی</h5>
                                <span class="lh-1-85">تمام امکانات جلسه</span>
                                <div class="d-flex align-items-center justify-content-center my-3 gap-2">
                                    <a href="javascript:;" class="me-1"><span class="badge bg-label-secondary">کنفرانس</span></a>
                                    <a href="javascript:;"><span class="badge bg-label-secondary">حضوری</span></a>
                                </div>

                                <div class="d-flex align-items-center justify-content-around my-4 py-2">
                                    <div>
                                        <h4 class="mb-1">500,000</h4>
                                        <span>پیامک</span>
                                    </div>
                                    <div>
                                        <h4 class="mb-1">100</h4>
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    <a href="#" class="btn btn-secondary d-flex align-items-center me-3"><i class="bx bx-user-check me-1"></i>خرید</a>
                                </div>
                            </div>
                        </div>
                    </div>
